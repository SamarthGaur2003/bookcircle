      ...
      <div className="animate-slide-up" style={{ width: '100%', maxWidth: 440 }}>
        <div className="glass card" style={{ padding: 48 }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 36 }}>
            ...
            <h1 className="heading" style={{ fontSize: '2rem', marginBottom: 8 }}>Create Account</h1>
            <p className="muted" style={{ margin: 0 }}>Join BookCircle and start trading books</p>
          </div>
          ...
          <form onSubmit={submit} style={{ display: 'grid', gap: 20 }}>
            ...
            <div>
              ...
              <input className="input" placeholder="+91 00000 00000"
                value={form.phone} onChange={e => setForm(v => ({ ...v, phone: e.target.value }))} required />
            </div>
